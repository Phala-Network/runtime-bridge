const apply = (program) => {
  program
    ...
    .requiredOption(
      '-e, --pruntime-endpoint <uri>',
      'HTTP endpoint of pRuntime'
    )
    .requiredOption(
      '-m, --controller-mnemonic <mnemonic>',
      'Private key or mnemonic of the controller account'
    )
    .action(
      ({
        nickname,
